% fd2dxKin2.m   2D finite-difference method for Scheme 1 applied to the predator-prey system with Kinetics 2.
...
C0=delta*L+sparse(1:n,1:n,1+delt*beta,n,n);
% Time-stepping procedure
for nt=1:N
    % Update coefficient matrices of linear system
    diag = abs(u);
    diag_entries = ones(n,1) - exp(-gamma*abs(u));;
    A = A0 + delt*sparse(1:n,1:n,diag,n,n);
    B = delt*sparse(1:n,1:n,diag_entries,n,n);
    C = C0 - delt*alpha*beta*sparse(1:n,1:n,diag_entries,n,n);
